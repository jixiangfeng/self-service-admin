...
const PaymentOpsManagement: React.FC = () => {
  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      <Tabs
        items={[
          { key: 'payment', label: '支付单', children: <ProTable<PaymentOrderRecord> cardBordered rowKey="id" columns={paymentColumns} dataSource={paymentOrderRecords} loading={paymentQuery.isLoading} search={false} pagination={{ pageSize: 8 }} scroll={{ x: 1460 }} toolBarRender={() => []} /> },
