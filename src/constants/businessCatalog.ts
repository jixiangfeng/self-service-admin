...
export const deviceProtocolTypeOptions = [
  { value: 'TCP', label: 'TCP' },
...
export const maintainStatusOptions = [
...
export const merchantGroupTypeOptions = [
...
export const costBearerOptions = [
...
export const profitRelationStatusOptions = [
...
export const balanceFlowTypeOptions = [
...
export const writeOffObjectTypeOptions = [
  { value: 'COUPON', label: '优惠券' },
...
export const writeOffMethodOptions = [
...
export const performSceneOptions = [
...
export const performStatusOptions = [
...
export const settlementSubjectTypeOptions = [
  { value: 'PLATFORM', label: '平台' },
  { value: 'MERCHANT', label: '商户' },
  { value: 'STORE', label: '门店' },
];

export const settlementDetailTypeOptions = [
...
export const storeOperationTaskTypeOptions = [
...
export const storeOperationTaskStatusOptions = [
...
export const storeNoticeTypeOptions = [
...
export const adContentTypeOptions = [
...
export const adDeliveryStatusOptions = [
  { value: 'PENDING', label: '待发布' },
  { value: 'RUNNING', label: '运行中' },
  { value: 'PAUSED', label: '暂停' },
  { value: 'ENDED', label: '已结束' },
...
export const deviceCommandStatusOptions = [
...
export const analysisSnapshotTypeOptions = [
...
export const reportDimensionOptions = [
  { value: 'PLATFORM', label: '平台' },
  { value: 'MERCHANT', label: '商户' },
  { value: 'STORE', label: '门店' },
  { value: 'CITY', label: '城市' },
...
export const activityRewardStatusOptions = [
...
export const inviteRecordStatusOptions = [
...
export const serviceCardStatusOptions = [
...
export const merchantTodoCategoryOptions = [
