...
const FIELD_ENUM_KEY_MAP: Record<string, BusinessEnumKey> = {
  ...
  serviceCardStatus: 'serviceCardStatusOptions',
  userServiceCardStatus: 'serviceCardStatusOptions',
  sourceType: 'balanceSourceTypeOptions',
  ...
  capabilityCode: 'storeServiceCapabilityOptions',
  ...
  billType: 'settlementSubjectTypeOptions',
...
const LABEL_ENUM_RULES: Array<[RegExp, BusinessEnumKey]> = [
  ...
  [/订单类型/, 'orderTypeOptions'],
  [/流水类型/, 'balanceFlowTypeOptions'],
  [/来源类型/, 'balanceSourceTypeOptions'],
  ...
  [/结算层级|结算主体类型/, 'settlementSubjectTypeOptions'],
