...
const FIELD_ENUM_KEY_MAP: Record<string, BusinessEnumKey> = {
  ...
  taskType: 'storeOperationTaskTypeOptions',
  taskStatus: 'storeOperationTaskStatusOptions',
  noticeType: 'storeNoticeTypeOptions',
...
const LABEL_ENUM_RULES: Array<[RegExp, BusinessEnumKey]> = [
  ...
  [/任务类型/, 'storeOperationTaskTypeOptions'],
  [/任务状态/, 'storeOperationTaskStatusOptions'],
  [/公告类型/, 'storeNoticeTypeOptions'],
